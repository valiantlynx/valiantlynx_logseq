...
- b) a fatigue failure analysis. Assume sharp fillet radii at the bearing shoulders for estimating stress concentration factors.
	...
	- \item[(b)] By fatigue-failure analysis, using the Goodman criterion:
		...
		- Diameter:
		  ...
		  \end{align*}
	- \item[(a)] Therefore, the minimum allowable diameter of the 250-mm section of the shaft based on (a) a static yield analysis using the distortion energy theory is 43.01 mm and (b) based on a fatigue failure analysis is 52.6 mm.
	- \end{enumerate}
	-